package com.hightaletech.restaurateur.listeners;
...
public class PlayerListener {
    ...
    public void register(EventRegistry eventBus) {
        ...
        try {
            ...
            LOGGER.at(Level.INFO).log("[Restaurateur] Registered PlayerConnectEvent listener");
        } catch (Exception e) {
            LOGGER.at(Level.WARNING).withCause(e).log("[Restaurateur] Failed to register PlayerConnectEvent");
        }

        // PlayerDisconnectEvent - When a player disconnects
        try {
            eventBus.register(PlayerDisconnectEvent.class, this::onPlayerDisconnect);
            LOGGER.at(Level.INFO).log("[Restaurateur] Registered PlayerDisconnectEvent listener");
        } catch (Exception e) {
            LOGGER.at(Level.WARNING).withCause(e).log("[Restaurateur] Failed to register PlayerDisconnectEvent");
        }
    }
    ...
    private void onPlayerConnect(PlayerConnectEvent event) {
        ...
        LOGGER.at(Level.INFO).log("[Restaurateur] Player %s connected to world %s", playerName, worldName);
    ...
    private void onPlayerDisconnect(PlayerDisconnectEvent event) {
        ...
        LOGGER.at(Level.INFO).log("[Restaurateur] Player %s disconnected", playerName);
