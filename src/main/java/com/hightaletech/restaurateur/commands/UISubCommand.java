...
import com.hightaletech.restaurateur.ui.RestaurateurDashboardUI;

import javax.annotation.Nonnull;

/**
 * /res ui - Open the plugin dashboard UI
 *
...
public class UISubCommand extends AbstractPlayerCommand {
    ...
    protected void execute(
        ...
        context.sendMessage(Message.raw("Opening Restaurateur Dashboard..."));
        ...
        try {
            ...
            RestaurateurDashboardUI dashboardPage = new RestaurateurDashboardUI(playerRef);
