package com.hightaletech.restaurateur.ui;
...
/**
 * Restaurateur Dashboard UI
 *
 * A simple interactive dashboard page showing plugin information
 * with refresh and close buttons.
 */
public class RestaurateurDashboardUI extends InteractiveCustomUIPage<RestaurateurDashboardUI.UIEventData> {

    // Path relative to Common/UI/Custom/
    public static final String LAYOUT = "restaurateur/Dashboard.ui";

    private final PlayerRef playerRef;
    private int refreshCount = 0;

    public RestaurateurDashboardUI(@Nonnull PlayerRef playerRef) {
